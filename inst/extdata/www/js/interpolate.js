...
function ComputeMidpoints(lat1, lon1, lat2, lon2){
    //get select  values
...
function ClearFormDir(){
    ...
    document.InputFormDir.crs12.value = "";
    document.InputFormDir.lon1.value = "0:00.00";
    document.InputFormDir.d12.value = "";
...
var EPS= 0.00000000005
var r, tu, sf, cf, b, cu, su, sa, c2a, x, c, d, y, sy, cy, cz,
    e
var glat2,glon2,baz
f
...
function getEllipsoid(selection){
  ...
  ells[9]= new ellipsoid("User",0.,0.)  // last one!
